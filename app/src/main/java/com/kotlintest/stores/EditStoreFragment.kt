...
import com.kotlintest.stores.databinding.FragmentEditStoreBinding
...
class EditStoreFragment : Fragment() {
    ...
    private fun validateFields(): Boolean {
        ...
        if (mBinding.etPhotoUrl.text.toString().trim().isEmpty()) {
            mBinding.tilPhotoUrl.error = getString(R.string.required_name)
            mBinding.etPhotoUrl.requestFocus()
            isValid = false
        }
        if (mBinding.etPhone.text.toString().trim().isEmpty()) {
            mBinding.tilPhone.error = getString(R.string.required_name)
            mBinding.etPhone.requestFocus()
            isValid = false
        }
        if (mBinding.etName.text.toString().trim().isEmpty()) {
            mBinding.tilName.error = getString(R.string.required_name)
    ...
    private fun validateFields(vararg textFields: TextInputLayout): Boolean {
        ...
        for (textField in textFields) {
            if (textField.editText?.text.toString().trim().isEmpty()) {
                textField.error = getString(R.string.required_name)
